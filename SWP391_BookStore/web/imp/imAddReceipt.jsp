    ...
    <head>
        ...
        <script>
            $(document).ready(function () {
                var html = '<tr><td><input type="number" name="code" min="0"  required></td><td><input type="text"  name="bname"  required></td><td><input type="number" name="qty"  min="1"  required></td><td><input type="number" name="price"  min="1"  required></td><td><input type="button" name="remove" value="Remove" id="remove" class="btn btn-danger"></td></tr>';
                var x = 1;
                var add_button = $("#add");
                                            ...
                                            <table id="table_field" class="table table-striped table-bordered zero-configuration">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><input  min="0"  type="number" name="code"   required></td>
                                                        <td><input type="text" name="bname"    required></td>
                                                        <td><input  min="1" type="number" name="qty"  required></td>
                                                        <td><input  min="1" type="number" name="price"   required></td>
